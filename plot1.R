...
# Draw Plot 1 using R Basic Plotting System
hist(as.numeric(rawdatasubset$Global_active_power), main="Global Active Power",  xlab="Global Active Power (kilowatts)", ylab="Frequency", col="Red")
